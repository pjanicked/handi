...
public partial class adminSite_viewFeedback : System.Web.UI.Page
{
    ...
    protected void btnSend_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            {
                emailMessage.From = new MailAddress("handicraftworldmumbai@gmail.com", "HandiCraft Wolrd");
                emailMessage.To.Add(new MailAddress(txtto.Text, "Receiver"));
                emailMessage.Subject = "Order Confirmation";
                emailMessage.Body = txtmsg.Text;
                emailMessage.Priority = MailPriority.Normal;
                using (SmtpClient MailClient = new SmtpClient("smtp.gmail.com", 587))
                {
                    MailClient.EnableSsl = true;
                    MailClient.Credentials = new System.Net.NetworkCredential("handicraftworldmumbai@gmail.com", "handicraftworld");
